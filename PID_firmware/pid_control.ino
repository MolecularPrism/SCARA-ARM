...
volatile long integral_error_sum = 0;
volatile int integral_sample_count = 0;
const int integral_sample_target = 100;  // for example, average over 100 samples
...
void pidControl() {
  ...
  // error
  error = desired_angle - absolute_angle;  // double check this
  ...
  // // Averaging logic
  // integral_error_sum += error_integral;
  // integral_sample_count++;

  // // Check if enough samples have been collected
  // if (integral_sample_count >= integral_sample_target) {
  //   float average_error_integral = (float)integral_error_sum / integral_sample_count;

  //   // Print the average
  //   Serial.print("Average Error Integral: ");
  //   Serial.println(average_error_integral);

  //   // Reset the sum and count for the next period
  //   integral_error_sum = 0;
  //   integral_sample_count = 0;
  // }
}
...
void loop() {
  // Check if there is data to read on the Serial port
  // if (Serial.available() > 0) {
  //   // Read the incoming data as a string
  //   String inputString = Serial.readStringUntil('\n');
    
  //   // Convert the string to an integer
  //   int newAngle = inputString.toInt();

  //   // Update the desired angle
  //   desired_angle = newAngle;

  //   Serial.print("Current position: ");
  //   Serial.println(absolute_angle);
  //   // Optional: Print a confirmation message
  //   Serial.print("New desired angle set to: ");
